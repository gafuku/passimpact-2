        ...
        <section className="bg-surface py-16 md:py-20 flex-1">
          <div className="mx-auto max-w-3xl px-inset">
            ...
            <p className="mt-4 text-text-muted max-w-xl">
              {reports.length} audited {reports.length === 1 ? "report" : "reports"} on file for {institution.shortName}, most recent first.
              Open one to explore the full breakdown and chat with the assistant built for that report.
            </p>
