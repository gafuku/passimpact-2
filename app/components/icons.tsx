...
export function IconLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M12 2L2 7l10 5 10-5-10-5zm0 2.8L18.4 7 12 10.2 5.6 7 12 4.8zm0 8.6L4.3 9l-.8.5L12 14l8.5-4.5-.8-.5L12 13.4zM12 17l-7.7-4-.8.5L12 18l8.5-4.5-.8-.5L12 17z" />
    </svg>
  );
}
